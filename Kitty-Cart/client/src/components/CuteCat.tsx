...
export function CuteCat() {
  ...
  return (
    ...
    >
      ...
      <motion.img 
        src="https://i.giphy.com/media/v1.Y2lkPTc5MGI3NjExOHYxcXNxd3B4Ynd4Ynd4Ynd4Ynd4Ynd4Ynd4Ynd4Ynd4Ynd4JmVwPXYxX2ludGVybmFsX2dpZl9ieV9pZCZjdD1n/GeimqsH0TLDt4tScGw/giphy.gif"
        alt="Cute Cat"
